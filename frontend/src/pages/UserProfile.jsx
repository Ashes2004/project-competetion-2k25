...
export default function UserProfile() {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      const resp = await fetch("http://riise.onrender.com/api/v1/users/profile", {
        credentials: "include",
      });
  ...
  const handleLogout = async () => {
    try {
      ...
      const response = await axios.post(
        "http://riise.onrender.com/api/v1/users/logout",
        {},
        {
  ...
  const handleExportReport = async () => {
    try {
      ...
      const response = await axios.get(
        "http://riise.onrender.com/api/v1/export/user",
        {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        "http://riise.onrender.com/api/v1/users/update_profile",
      ...
      const updatedProfile = await fetch("http://riise.onrender.com/api/v1/users/profile", {
        credentials: "include",
      });
